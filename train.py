...
def _main(parsed_args):
    ...
    annotation_path = parsed_args.annotation_path
    log_dir = parsed_args.log_dir
    classes_path = parsed_args.classes_path
    anchors_path = parsed_args.anchors_path
    ...
    if True:
        ...
        batch_size = parsed_args.fine_tune_batch_size
        ...
        model.save_weights(path.join(output_dir, 'trained_weights_final.h5'))
...
def handle_args():
    ...
    parser.add_argument('--classes-path',
                        help="Path to the class file",
                        dest="classes_path",
                        type=str,
                        default='model_data/voc_classes.txt')

    parser.add_argument('--anchors-path',
    ...
    parser.add_argument('-o',
                        '--output-dir',
                        help="Output path for the trained model weight",
                        dest="output_dir",
                        type=str,
                        default="")
